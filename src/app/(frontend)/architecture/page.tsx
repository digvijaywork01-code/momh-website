...
export async function generateMetadata(): Promise<Metadata> {
  ...
  try {
    page = (await getCachedDocument('pages', 'architecture', 2)()) as PageType | undefined
  } catch {
    page = undefined
  }
  return generateMeta({ doc: page ?? null, pageTitle: "The Architecture" })
}

/**
 * /architecture — Payload-managed editorial page (The Architecture).
 *
