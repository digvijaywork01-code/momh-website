    ...
    <html lang="en" suppressHydrationWarning>
      ...
      <body className="overflow-x-hidden">
        <Providers>
          ...
          <div className={needsMobilePadding ? 'pt-[16vh] mobile-padding-custom sm:pt-[20vh]' : ''}>
            {children}
          </div>
          ...
          {!hideGlobalElements && (
            ...
            // other block. `min-h-screen` makes the snap manager land
            ...
            <div
              ...
              // attribute is omitted AND the min-h-screen is dropped so
              // the footer wrapper hugs its content (flower row +
              // footer) instead of leaving an awkward black slab
              // above. On snap pages, min-h-screen + justify-end keeps
