 ...
 *  - The section is a normal full-viewport (h-screen) block. One
...
export const HeroBlock: React.FC<HeroBlockProps> = ({
  ...
  return (
    <section
      ...
      role="button"
      tabIndex={0}
      /* Full viewport height — using `h-screen` rather than the PDF's
      ...
      // lg+: original h-screen for the full editorial entrance.
      className="relative w-full h-[50vh] lg:h-screen overflow-hidden text-offwhite cursor-pointer select-none focus:outline-none"
      data-theme="dark"
